...
public class Ajuda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LabelSenha.setFont(new java.awt.Font("Monospaced", 0, 13)); // NOI18N
        LabelSenha.setText("Senha padrão: 0");

        LabelUsuario.setFont(new java.awt.Font("Monospaced", 0, 13)); // NOI18N
        LabelUsuario.setText("Usuário padrão: 0");

        LabelCriador.setFont(new java.awt.Font("Monospaced", 0, 13)); // NOI18N
